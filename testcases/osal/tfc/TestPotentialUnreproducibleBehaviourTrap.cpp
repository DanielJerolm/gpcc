...
TEST(gpcc_tests_osal_tfc_PotentialUnreproducibleBehaviourTrap_Tests, InstantiationAndMonitoring)
{
...
TEST(gpcc_tests_osal_tfc_PotentialUnreproducibleBehaviourTrap_Tests, DTORendsMonitoring)
{
  using gpcc::osal::internal::TFCCore;
  TFCCore* pTFC = TFCCore::Get();
...
TEST(gpcc_tests_osal_tfc_PotentialUnreproducibleBehaviourTrap_Tests, InvalidUse)
{
  PotentialUnreproducibleBehaviourTrap uut;
...
TEST(gpcc_tests_osal_tfc_PotentialUnreproducibleBehaviourTrap_Tests, QueryAndResetTrap)
{
