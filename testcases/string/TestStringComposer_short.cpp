...
TEST(gpcc_string_StringComposer, Append_short_baseHex_showBase_Width4_Zero)
{
  short z = 0;
...
TEST(gpcc_string_StringComposer, Append_short_baseHex_showBase_Width0_Zero)
{
  short z = 0;
...
TEST(gpcc_string_StringComposer, Append_short_baseOctal_showBase_Width4_Zero)
{
  short z = 0;
...
TEST(gpcc_string_StringComposer, Append_short_baseOctal_showBase_Width0_Zero)
{
  short z = 0;
