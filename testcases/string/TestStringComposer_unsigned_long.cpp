...
TEST(gpcc_string_StringComposer, Append_ulong_baseHex_showBase_Width4_Zero)
{
  unsigned long z = 0;
...
TEST(gpcc_string_StringComposer, Append_ulong_baseHex_showBase_Width0_Zero)
{
  unsigned long z = 0;
...
TEST(gpcc_string_StringComposer, Append_ulong_baseHex_noShowBase_alignRightPadZero)
{
  unsigned long v1 = 184;
  unsigned long v2 = 44;
...
TEST(gpcc_string_StringComposer, Append_ulong_baseHex_showBase_UpperCaseLowerCase_alignRightPadZero)
{
  unsigned long v1 = 184;
  unsigned long v2 = 44;
...
TEST(gpcc_string_StringComposer, Append_ulong_baseOctal_showBase_Width4_Zero)
{
  unsigned long z = 0;
...
TEST(gpcc_string_StringComposer, Append_ulong_baseOctal_showBase_Width0_Zero)
{
  unsigned long z = 0;
