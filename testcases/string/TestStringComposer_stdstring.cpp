...
TEST(gpcc_string_StringComposer, Append_stdstring_defaults)
{
  std::string const v1 = "Test";
  std::string const v2 = "123";
...
TEST(gpcc_string_StringComposer, Append_stdstring_emptyString)
{
  std::string const v1 = "";
  std::string const v2 = "123";
...
TEST(gpcc_string_StringComposer, Append_stdstring_defaultAlignmentRight)
{
  std::string const v1 = "Test";
  std::string const v2 = "123";
...
TEST(gpcc_string_StringComposer, Append_stdstring_alignLeft_widthIsNotSticky)
{
  std::string const v1 = "Test";
  std::string const v2 = "123";
...
TEST(gpcc_string_StringComposer, Append_stdstring_alignLeftIsSticky)
{
  std::string const v1 = "Test";
  std::string const v2 = "123";
...
TEST(gpcc_string_StringComposer, Append_stdstring_alignRight_widthIsNotSticky)
{
  std::string const v1 = "Test";
  std::string const v2 = "123";
...
TEST(gpcc_string_StringComposer, Append_stdstring_alignRightIsSticky)
{
  std::string const v1 = "Test";
  std::string const v2 = "123";
...
TEST(gpcc_string_StringComposer, Append_stdstring_alignRightPadZeroPadsWithWhiteSpaces)
{
  std::string const v1 = "Test";
  std::string const v2 = "123";
...
TEST(gpcc_string_StringComposer, Append_stdstring_showPosHasNoEffect)
{
  std::string const v1 = "Test";
...
TEST(gpcc_string_StringComposer, Append_stdstring_baseHexHasNoEffect)
{
  std::string const v = "Test";
...
TEST(gpcc_string_StringComposer, Append_stdstring_baseOctHasNoEffect)
{
  std::string const v = "Test";
...
TEST(gpcc_string_StringComposer, Append_stdstring_showBaseHasNoEffect)
{
  std::string const v = "Test";
...
TEST(gpcc_string_StringComposer, Append_stdstring_uppercaseHasNoEffect)
{
  std::string const v = "Test";
