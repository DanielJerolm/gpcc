...
#ifndef THREAD_HPP_202509290825
#define THREAD_HPP_202509290825
...
class Thread final
{
  public:
    ...
    void Start(tEntryFunction const & entryFunction,
  ...
  private:
    ...
    /** Locking order: @ref joinMutex_ -> @ref mutex_ */
    ...
    /** This is used to pass the thread entry function functor from @ref Start() to @ref InternalThreadEntry2(). \n
        This is only modified by @ref Start() while @ref threadState_ is @ref ThreadState::noThreadOrJoined. */
    tEntryFunction entryFunction_;

    /// Current state of the thread managed by this object.
    /** @ref mutex_ is required. */
    ThreadState threadState_;

    /// Condition variable signaled when @ref threadState_ is set to @ref ThreadState::running.
    /** This is to be used in conjunction with @ref mutex_. */
    ConditionVariable threadStateRunningCondVar_;


    /// Pointer to allocated stack.
    /** @ref mutex_ is required.\n
        If @ref threadState_ is @ref ThreadState::noThreadOrJoined, then this is `nullptr`. */
    k_thread_stack_t* pStack_;
    ...
    static void InternalThreadEntry1(void* p1, void* p2, void* p3) noexcept;
    void InternalThreadEntry2(void) noexcept;

    int UniversalPrioToZephyrPrio(priority_t const priority, SchedPolicy const schedpolicy) const;
};
...
#endif // #ifndef THREAD_HPP_202509290825
