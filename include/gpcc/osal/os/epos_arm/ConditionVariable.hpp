...
#ifndef CONDITIONVARIABLE_HPP_202404232023
#define CONDITIONVARIABLE_HPP_202404232023

#include <gpcc/osal/Mutex.hpp>
#include <gpcc/time/clock.hpp>
#include <epos/scheduler/convar.h>
...
class ConditionVariable final
{
  ...
  private:
    /// The encapsulated EPOS condition variable.
    epos_convar_t condVar;
};
...
{
  epos_convar_Broadcast(&condVar);
}

} // namespace osal
} // namespace gpcc

#endif // #ifndef CONDITIONVARIABLE_HPP_202404232023
